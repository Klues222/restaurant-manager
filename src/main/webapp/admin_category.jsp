...
<head>
    ...
    <script>
        function delete_cate2(uId){
            $.post("delCategory2",{"csId":uId},function (data){
                alert(data);
    ...
    <div class="function-module">
        ...
        <div class="main_list">
            <table border="1">
                <thead>
                <tr>
                    <td colspan="2" align="center">类型信息</td>
                    <td colspan="1" align="center">操作</td>
                </tr>
                <tr>
                    <td width=160px align="center">二级商品Id</td>
                    <td width=160px align="center">二级商品名</td>
                    <td width="160px" align="center">删除</td>
                </tr>
                </thead>
                <tbody id="goodsT">
                <c:forEach items="${category2}" var="cate">
                    <tr>
                        <td width=160px align="center">${cate.csid}</td>
                        <td width=160px align="center">${cate.csname}</td>
                        <td width="160px" align="center"><input type="button" value="删除" onclick="delete_cate2('${cate.csid}')"></td>
                    </tr>
                </c:forEach>
                </tbody>
