...
<head>
    ...
    <script>
        function confirm(oState,oId){
            if(oState==='1'){
                $.post("appCheck",{"oId":oId},function (data){
                    alert(data);
                    location.href = location.href;

                })
            }else{
                $.post("delOrder",{"oId":oId},function (data){
                    alert(data);
                    location.href = location.href;
        ...
        <div class="main_list">
            <table border="1">
                ...
                <tr>
                    ...
                    <td width="140px" colspan="2" align="center">确认</td>
                </tr>
                </thead>
                <tbody id="goodsT">
...
<%--                    int oid, Double totalMoney, int oState, String tableId, String pickupId, Timestamp orderTime, int uid--%>
                    <tr>
                        ...
                        <td align="center"><input  type = "button" value = "确认" onclick="confirm('${orders.oState}','${orders.oid}')"></td>
                    </tr>
                </c:forEach>
                </tbody>
                <tfoot></tfoot>
